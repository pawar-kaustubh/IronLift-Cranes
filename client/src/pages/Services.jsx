      ...
      <section className="relative overflow-hidden pt-24 sm:pt-28 pb-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-12 gap-8 items-end">
          <div className="lg:col-span-7">
            ...
            >
              Crane classes built for{" "}
              <span className="text-amber-500">real jobsites</span>
            </motion.h1>
            <p className="type-body text-zinc-400 mt-6 max-w-2xl">
              Browse the fleet below and click any crane to send yourself straight
              to the contact page with the right crane already selected.
            </p>
          </div>
          ...
          <div className="lg:col-span-5 grid grid-cols-2 gap-px bg-zinc-900">
            {ICONS.map((Icon, index) => (
              <div
                key={index}
                className="bg-[#0a0a0a] p-6 sm:p-8 min-h-[140px] flex flex-col justify-between"
              >
            ...
            {CRANE_FLEET.map((crane, index) => (
              ...
              >
                <motion.article
                  ...
                  className="group flex flex-col h-full relative bg-[#0a0a0a] overflow-hidden border border-zinc-900 hover:border-amber-500/40 hover:bg-zinc-950 transition-all duration-300"
                >
                  {/* IMAGE */}
                  ...
                  <div className="flex flex-col flex-grow p-6 sm:p-8">
                    ...
                    <div className="flex items-start justify-between gap-4 mb-3">
                      <h2 className="type-h3 font-semibold uppercase">
                        {crane.name}
                      </h2>
                    ...
                    {/* DESCRIPTION */}
                    <p className="type-body text-zinc-400 mb-6 flex-grow">
                      {crane.description}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {crane.details.map((detail) => (
                        <span
                          key={detail}
                          className="border border-zinc-800 px-3 py-2 text-[11px] uppercase tracking-[0.25em] text-zinc-300"
                        >
                          {detail}
                        </span>
                      ))}
                    ...
                    {/* BOTTOM FIXED */}
                    <div className="mt-auto grid grid-cols-2 gap-4 pt-5 border-t border-zinc-900">
                      <div>
                        <div className="font-mono type-eyebrow uppercase tracking-[0.3em] text-zinc-600">
                          Reach
                        </div>
                        <div className="type-small text-white mt-1">
                          {crane.reach}
                        </div>
                      </div>
