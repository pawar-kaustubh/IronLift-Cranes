    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-zinc-900">
          {SERVICES.map((s, i) => (
            <Link key={s.tag} to={`/contact?crane=${s.slug}`} state={{ selectedCrane: s }} className="block">
              <motion.article
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, amount: 0.2 }}
                transition={{ duration: 0.6, delay: i * 0.06 }}
                className="group relative bg-[#0a0a0a] hover:bg-zinc-950 transition-all duration-300 overflow-hidden border border-zinc-900 hover:border-amber-500/40 shadow-[0_0_0_0_rgba(0,0,0,0)] hover:shadow-[0_20px_40px_-20px_rgba(0,0,0,0.6)] transform hover:-translate-y-1"
              ...
              <div className="relative aspect-[4/3] overflow-hidden">
                <img
                  ...
                  alt={s.name}
                  loading="lazy"
                  className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700 group-hover:saturate-125 group-hover:contrast-110"
                />
              ...
              <div className="p-6 sm:p-8">
                ...
                <p className="type-body text-zinc-400 mb-5">
                  {s.summary}
                </p>
